...
static String_And_Flag keywords[] = {
    ...
    // stdtypes.h
    {make_lit_string("int8_t")           , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int16_t")          , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int32_t")          , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int64_t")          , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int_fast8_t")      , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int_fast16_t")     , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int_fast32_t")     , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int_fast64_t")     , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int_least8_t")     , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int_least16_t")    , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int_least32_t")    , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("int_least64_t")    , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("intmax_t")         , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("intptr_t")         , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint8_t")          , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint16_t")         , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint32_t")         , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint64_t")         , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint_fast8_t")     , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint_fast16_t")    , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint_fast32_t")    , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint_fast64_t")    , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint_least8_t")    , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint_least16_t")   , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint_least32_t")   , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uint_least64_t")   , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uintmax_t")        , CPP_TOKEN_KEY_TYPE},
    {make_lit_string("uintptr_t")        , CPP_TOKEN_KEY_TYPE},

    // stdlib.h / stddef.h
    {make_lit_string("size_t")           , CPP_TOKEN_KEY_TYPE},
